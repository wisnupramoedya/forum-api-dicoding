...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(
      DomainErrorTranslator.translate(new NotFoundError('THREAD.NOT_FOUND')),
    ...
    expect(
      DomainErrorTranslator.translate(new NotFoundError('COMMENT.NOT_FOUND')),
    ).toStrictEqual(new NotFoundError('comment tidak ditemukan'));
    expect(
      DomainErrorTranslator.translate(
        new AuthorizationError('COMMENT.NOT_AUTHORIZED'),
      ),
    ).toStrictEqual(
    ...
    expect(
      DomainErrorTranslator.translate(new NotFoundError('REPLY.NOT_FOUND')),
    ).toStrictEqual(new NotFoundError('reply tidak ditemukan'));
    expect(
      DomainErrorTranslator.translate(
        new AuthorizationError('REPLY.NOT_AUTHORIZED'),
      ),
    ).toStrictEqual(
      new AuthorizationError('anda tidak berhak mengakses resource ini'),
    );
